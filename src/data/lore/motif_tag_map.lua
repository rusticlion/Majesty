...
M.EXACT = {
    ...
    ["infiltrated location"] = { "stealth", "scouting", "security", "traps", "hazard", "observation" },
...
M.KEYWORDS = {
    ...
    alchemist = { "alchemy", "reagent", "reagents", "occult" },
    alchemical = { "alchemy", "reagent", "reagents" },
    reagent = { "alchemy", "reagent", "reagents" },
    reagents = { "alchemy", "reagent", "reagents" },
    apothecary = { "alchemy", "reagent", "medicine" },
    ...
    infiltrated = { "stealth", "scouting", "security", "traps", "hazard", "observation" },
    infiltrate = { "stealth", "scouting", "security", "traps", "hazard", "observation" },
    infiltration = { "stealth", "scouting", "security", "traps", "hazard", "observation" },
    scouted = { "scouting", "observation", "hazard" },
    sneak = { "stealth", "scouting" },
    sneaking = { "stealth", "scouting" },
